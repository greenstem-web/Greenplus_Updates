# Greenplus Accounting v1.1.18 - Update Package
...
âœ… Your database connection settings will NOT be affected
âœ… Your custom configurations will be preserved
âœ… No need to reconfigure after update
âœ… Application will connect to the same databases as before
